...
describe('multi remote test2', () => {
    ...
    describe('chat test2', () => {
        ...
        it.skip('should login the browser A2', async () => {
        ...
        it.skip('should login the browser B2', async () => {
        ...
        it('can access shared store2', async () => {
